const level = {
  ...
  enemies: [
    ...
    { x: 1400, y: 455, width: 40, height: 48, velocityX: -2, alive: true, type: 'rollpod', isShell: false, shellVelocity: 0 },
    { x: 1850, y: 455, width: 40, height: 40, velocityX: -2, alive: true, type: 'pebblit' },
    { x: 2000, y: 455, width: 36, height: 36, velocityX: -2, alive: true, type: 'prismite' },
    { x: 2550, y: 455, width: 40, height: 40, velocityX: -2.5, alive: true, type: 'pebblit' },
    { x: 3150, y: 455, width: 36, height: 36, velocityX: -2.5, alive: true, type: 'prismite' },
    { x: 3350, y: 455, width: 40, height: 48, velocityX: -2.5, alive: true, type: 'rollpod', isShell: false, shellVelocity: 0 },
  ],
  powerUps: [
